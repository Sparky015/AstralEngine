...
namespace Astral {
    ...
    VkImageLayout ConvertImageLayoutToVkImageLayout(ImageLayout imageLayout)
    {
        switch (imageLayout)
        {
            case Astral::ImageLayout::UNDEFINED: return VK_IMAGE_LAYOUT_UNDEFINED;
            case Astral::ImageLayout::GENERAL: return VK_IMAGE_LAYOUT_GENERAL;
            case Astral::ImageLayout::COLOR_ATTACHMENT_OPTIMAL: return VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;
            case Astral::ImageLayout::DEPTH_STENCIL_ATTACHMENT_OPTIMAL: return VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL;
            case Astral::ImageLayout::DEPTH_STENCIL_READ_ONLY_OPTIMAL: return VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL;
            case Astral::ImageLayout::SHADER_READ_ONLY_OPTIMAL: return VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
            case Astral::ImageLayout::TRANSFER_SRC_OPTIMAL: return VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL;
            case Astral::ImageLayout::TRANSFER_DST_OPTIMAL: return VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL;
            case Astral::ImageLayout::PREINITIALIZED: return VK_IMAGE_LAYOUT_PREINITIALIZED;
            case Astral::ImageLayout::DEPTH_READ_ONLY_STENCIL_ATTACHMENT_OPTIMAL: return VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_STENCIL_ATTACHMENT_OPTIMAL;
            case Astral::ImageLayout::DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMAL: return VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMAL;
            case Astral::ImageLayout::DEPTH_ATTACHMENT_OPTIMAL: return VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL;
            case Astral::ImageLayout::DEPTH_READ_ONLY_OPTIMAL: return VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL;
            case Astral::ImageLayout::STENCIL_ATTACHMENT_OPTIMAL: return VK_IMAGE_LAYOUT_STENCIL_ATTACHMENT_OPTIMAL;
            case Astral::ImageLayout::STENCIL_READ_ONLY_OPTIMAL: return VK_IMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMAL;
            case Astral::ImageLayout::READ_ONLY_OPTIMAL: return VK_IMAGE_LAYOUT_READ_ONLY_OPTIMAL;
            case Astral::ImageLayout::ATTACHMENT_OPTIMAL: return VK_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL;
            case Astral::ImageLayout::PRESENT_SRC_KHR: return VK_IMAGE_LAYOUT_PRESENT_SRC_KHR;
            case Astral::ImageLayout::VIDEO_DECODE_DST_KHR: return VK_IMAGE_LAYOUT_VIDEO_DECODE_DST_KHR;
            case Astral::ImageLayout::VIDEO_DECODE_SRC_KHR: return VK_IMAGE_LAYOUT_VIDEO_DECODE_SRC_KHR;
            case Astral::ImageLayout::VIDEO_DECODE_DPB_KHR: return VK_IMAGE_LAYOUT_VIDEO_DECODE_DPB_KHR;
            case Astral::ImageLayout::SHARED_PRESENT_KHR: return VK_IMAGE_LAYOUT_SHARED_PRESENT_KHR;
            case Astral::ImageLayout::FRAGMENT_DENSITY_MAP_OPTIMAL_EXT: return VK_IMAGE_LAYOUT_FRAGMENT_DENSITY_MAP_OPTIMAL_EXT;
            case Astral::ImageLayout::FRAGMENT_SHADING_RATE_ATTACHMENT_OPTIMAL_KHR: return VK_IMAGE_LAYOUT_FRAGMENT_SHADING_RATE_ATTACHMENT_OPTIMAL_KHR;
            case Astral::ImageLayout::RENDERING_LOCAL_READ_KHR: return VK_IMAGE_LAYOUT_RENDERING_LOCAL_READ_KHR;
            case Astral::ImageLayout::VIDEO_ENCODE_DST_KHR: return VK_IMAGE_LAYOUT_VIDEO_ENCODE_DST_KHR;
            case Astral::ImageLayout::VIDEO_ENCODE_SRC_KHR: return VK_IMAGE_LAYOUT_VIDEO_ENCODE_SRC_KHR;
            case Astral::ImageLayout::VIDEO_ENCODE_DPB_KHR: return VK_IMAGE_LAYOUT_VIDEO_ENCODE_DPB_KHR;
            case Astral::ImageLayout::ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT: return VK_IMAGE_LAYOUT_ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT;
            case Astral::ImageLayout::DEPTH_READ_ONLY_STENCIL_ATTACHMENT_OPTIMAL_KHR: return VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_STENCIL_ATTACHMENT_OPTIMAL_KHR;
            case Astral::ImageLayout::DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMAL_KHR: return VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMAL_KHR;
            case Astral::ImageLayout::SHADING_RATE_OPTIMAL_NV: return VK_IMAGE_LAYOUT_SHADING_RATE_OPTIMAL_NV;
            case Astral::ImageLayout::DEPTH_ATTACHMENT_OPTIMAL_KHR: return VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL_KHR;
            case Astral::ImageLayout::DEPTH_READ_ONLY_OPTIMAL_KHR: return VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL_KHR;
            case Astral::ImageLayout::STENCIL_ATTACHMENT_OPTIMAL_KHR: return VK_IMAGE_LAYOUT_STENCIL_ATTACHMENT_OPTIMAL_KHR;
            case Astral::ImageLayout::STENCIL_READ_ONLY_OPTIMAL_KHR: return VK_IMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMAL_KHR;
            case Astral::ImageLayout::READ_ONLY_OPTIMAL_KHR: return VK_IMAGE_LAYOUT_READ_ONLY_OPTIMAL_KHR;
            case Astral::ImageLayout::ATTACHMENT_OPTIMAL_KHR: return VK_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL_KHR;
