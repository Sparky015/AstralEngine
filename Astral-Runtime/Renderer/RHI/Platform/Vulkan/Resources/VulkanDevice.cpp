...
namespace Astral {
    ...
    TextureHandle VulkanDevice::CreateTexture(ImageFormat imageFormat, ImageLayout imageLayout, UVec2 dimensions, uint8* imageData)
    {
        VulkanTextureDesc textureDesc = {
            ...
            .ImageWidth = dimensions.x,
            .ImageHeight = dimensions.y,
        };
