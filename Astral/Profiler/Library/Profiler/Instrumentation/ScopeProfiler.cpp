...
namespace Astral::Macros {
    ...
    macro_SCOPE_PROFILER::macro_SCOPE_PROFILER(const char* title) noexcept
        ...
        m_StartAllocationCount(0)//Astral::MemoryTracker::Get().GetMemoryMetrics().GetThreadTotalAllocations(std::this_thread::get_id()))
    {}
    ...
    macro_SCOPE_PROFILER::~macro_SCOPE_PROFILER() noexcept
    {
        ...
        m_EndAllocationCount = 0;//Astral::MemoryTracker::Get().GetMemoryMetrics().GetThreadTotalAllocations(std::this_thread::get_id());
