...
//  2023-07-18: Inputs: Revert ignoring mouse data on GLFW_CURSOR_DISABLED as it can be used differently. Application may set ImGuiConfigFLags_NoMouse if desired. (#5625, #6609)
