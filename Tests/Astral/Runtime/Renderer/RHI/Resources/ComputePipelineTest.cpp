...
class ComputePipelineTest : public ::testing::TestWithParam<std::pair<const char*, ShaderType>>
{
protected:
...
TEST_P(ComputePipelineTest, ShaderSource_Constructor_CorrectlyLoadsShaderSourceFromDisk)
{
