...
namespace Game {
    ...
    public:
        ...
        Board FEN_board{Board("5kr1/1p2qp2/1Qb1p1pp/p1ppn1R1/PrN1PBnP/1RP1bN2/1P2KPP1/5B2 w - - 3 23")};
        MoveList whiteMoveList{FEN_board, PieceColor::WHITE};
        MoveList blackMoveList{FEN_board, PieceColor::BLACK};
    };
